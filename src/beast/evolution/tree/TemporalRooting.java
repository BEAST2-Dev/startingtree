...
//import beast.evolution.util.TimeScale;
...
//
//            dates[i] = regression.getXIntercept() + (distances[i] / regression.getSlope());
//        }
//
//        return new Regression(dates, distances);
//    }
...
//                    if (Math.abs(r.getSlope() - targetRate) < minDiff) {
//                        minDiff = Math.abs(r.getSlope() - targetRate);
//                        bestTree = tmpTree;
//                    }
//                } else {
//                    if (f < minF) {
...
//
//        final Set<Node> tipSet1 = node1.getAllLeafNodes();
//        final Set<Node> tipSet2 = node2.getAllLeafNodes();
//
...
//                        score = (r.getSlope() < 0.0 ? -score : score);
//                    }
//
//                } else {
...
//                Node tip = tree.getExternalNode(i);
//
